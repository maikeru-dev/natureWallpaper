...
let apikey = {
    'pexel': "Bearer 563492ad6f917000010000011c2607a74b374f9f8daf3428ddc31151",
...
function main() { // runs at the bottom!
...
function checkTime() {
    ...
    if (nowTime.getDay() >= 5) {
        ...
        text = welcomeData.greetings[Math.floor(nowTime.getHours() / 6)] + ' ' + username
